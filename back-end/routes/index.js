...
var Neuralnetwork = require('../controllers/neural-network.js')
...
router.get('/clusterHclust', Clustering.clusterHclust)
...
router.get('/getWellsData', Table.getWellsData)
router.get('/getInjectionData', Table.getInjectionData)
router.get('/getProductionData', Table.getProductionData)
router.get('/getStatisticsData', Table.getStatisticsData)
router.get('/runANN', Neuralnetwork.runANN)
router.get('/runLSTM', Neuralnetwork.runLSTM)
router.get('/getDataSeries', Neuralnetwork.getDataSeries)
router.get('/getDataTable', Neuralnetwork.getDataTable)
